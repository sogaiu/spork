...
(assert (= (date/assert-date (date/from-string "2024-12-16" "yyyy-MM-dd"))
           {:format-str "yyyy-MM-dd" :date-str "2024-12-16" :dst false :hours 0 :minutes 0 :month 11 :month-day 15 :seconds 0 :week-day 1 :year 2024 :year-day 350}))
(assert (= (date/assert-date (date/from-string "January 1, 2021" "MMMM d, yyyy"))
           {:date-str "January 1, 2021" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 0 :month-day 0 :seconds 0 :week-day 5 :year 2021 :year-day 0}))
(assert (= (date/assert-date (date/from-string "01-AUG-24" "dd-MMM-yy"))
           {:date-str "01-AUG-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 7 :month-day 0 :seconds 0 :week-day 4 :year 2024 :year-day 213}))
(assert (= (date/assert-date (date/from-string "22" "yy"))
           {:date-str "22" :format-str "yy" :dst false :hours 0 :minutes 0 :month 0 :month-day 0 :seconds 0 :week-day 6 :year 2022 :year-day 0}))
(assert (= (date/assert-date (date/from-string "2024-12-31" "yyyy-MM-dd"))
           {:date-str "2024-12-31" :format-str "yyyy-MM-dd" :dst false :hours 0 :minutes 0 :month 11 :month-day 30 :seconds 0 :week-day 2 :year 2024 :year-day 365}))
(assert (= (date/assert-date (date/from-string "01-AUG-24" "dd-MMM-yy"))
           {:date-str "01-AUG-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 7 :month-day 0 :seconds 0 :week-day 4 :year 2024 :year-day 213}))
(assert (= (date/assert-date (date/from-string "08/22" "MM/yy"))
           {:date-str "08/22" :format-str "MM/yy" :dst false :hours 0 :minutes 0 :month 7 :month-day 0 :seconds 0 :week-day 1 :year 2022 :year-day 212}))
(assert (= (date/assert-date (date/from-string "08/22" "MM/dd"))
           {:date-str "08/22" :format-str "MM/dd" :dst false :hours 0 :minutes 0 :month 7 :month-day 21 :seconds 0 :week-day 6 :year 1970 :year-day 233}))
(assert (= (date/assert-date (date/from-string "2024-01-10 04:30 PM" "yyyy-dd-MM hh:mm AM"))
           {:date-str "2024-01-10 04:30 PM" :format-str "yyyy-dd-MM hh:mm AM" :dst false :hours 16 :minutes 30 :month 9 :month-day 0 :seconds 0 :week-day 2 :year 2024 :year-day 274}))
(assert (= (date/assert-date (date/from-string "2024-01-10 17:30" "yyyy-MM-dd HH:mm"))
           {:date-str "2024-01-10 17:30" :format-str "yyyy-MM-dd HH:mm" :dst false :hours 17 :minutes 30 :month 0 :month-day 9 :seconds 0 :week-day 3 :year 2024 :year-day 9}))

(assert (= (date/assert-date (date/from-string "January 1, 2021" "MMMM d, yyyy"))
           {:date-str "January 1, 2021" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 0 :month-day 0 :seconds 0 :week-day 5 :year 2021 :year-day 0}))
(assert (= (date/assert-date (date/from-string "February 2, 2022" "MMMM d, yyyy"))
           {:date-str "February 2, 2022" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 1 :month-day 1 :seconds 0 :week-day 3 :year 2022 :year-day 32}))
(assert (= (date/assert-date (date/from-string "March 3, 2023" "MMMM d, yyyy"))
           {:date-str "March 3, 2023" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 2 :month-day 2 :seconds 0 :week-day 5 :year 2023 :year-day 61}))
(assert (= (date/assert-date (date/from-string "April 4, 2024" "MMMM d, yyyy"))
           {:date-str "April 4, 2024" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 3 :month-day 3 :seconds 0 :week-day 4 :year 2024 :year-day 94}))
(assert (= (date/assert-date (date/from-string "May 5, 2025" "MMMM d, yyyy"))
           {:date-str "May 5, 2025" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 4 :month-day 4 :seconds 0 :week-day 1 :year 2025 :year-day 124}))
(assert (= (date/assert-date (date/from-string "June 6, 2026" "MMMM d, yyyy"))
           {:date-str "June 6, 2026" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 5 :month-day 5 :seconds 0 :week-day 6 :year 2026 :year-day 156}))
(assert (= (date/assert-date (date/from-string "July 7, 2027" "MMMM d, yyyy"))
           {:date-str "July 7, 2027" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 6 :month-day 6 :seconds 0 :week-day 3 :year 2027 :year-day 187}))
(assert (= (date/assert-date (date/from-string "August 8, 2028" "MMMM d, yyyy"))
           {:date-str "August 8, 2028" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 7 :month-day 7 :seconds 0 :week-day 2 :year 2028 :year-day 220}))
(assert (= (date/assert-date (date/from-string "September 9, 2029" "MMMM d, yyyy"))
           {:date-str "September 9, 2029" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 8 :month-day 8 :seconds 0 :week-day 0 :year 2029 :year-day 251}))
(assert (= (date/assert-date (date/from-string "October 10, 2030" "MMMM d, yyyy"))
           {:date-str "October 10, 2030" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 9 :month-day 9 :seconds 0 :week-day 4 :year 2030 :year-day 282}))
(assert (= (date/assert-date (date/from-string "November 11, 2031" "MMMM d, yyyy"))
           {:date-str "November 11, 2031" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 10 :month-day 10 :seconds 0 :week-day 2 :year 2031 :year-day 314}))
(assert (= (date/assert-date (date/from-string "December 12, 2032" "MMMM d, yyyy"))
           {:date-str "December 12, 2032" :format-str "MMMM d, yyyy" :dst false :hours 0 :minutes 0 :month 11 :month-day 11 :seconds 0 :week-day 0 :year 2032 :year-day 346}))

(assert (= (date/assert-date (date/from-string "01-JAN-24" "dd-MMM-yy"))
           {:date-str "01-JAN-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 0 :month-day 0 :seconds 0 :week-day 1 :year 2024 :year-day 0}))
(assert (= (date/assert-date (date/from-string "02-FEB-24" "dd-MMM-yy"))
           {:date-str "02-FEB-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 1 :month-day 1 :seconds 0 :week-day 5 :year 2024 :year-day 32}))
(assert (= (date/assert-date (date/from-string "03-MAR-24" "dd-MMM-yy"))
           {:date-str "03-MAR-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 2 :month-day 2 :seconds 0 :week-day 0 :year 2024 :year-day 62}))
(assert (= (date/assert-date (date/from-string "04-APR-24" "dd-MMM-yy"))
           {:date-str "04-APR-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 3 :month-day 3 :seconds 0 :week-day 4 :year 2024 :year-day 94}))
(assert (= (date/assert-date (date/from-string "05-MAY-24" "dd-MMM-yy"))
           {:date-str "05-MAY-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 4 :month-day 4 :seconds 0 :week-day 0 :year 2024 :year-day 125}))
(assert (= (date/assert-date (date/from-string "06-JUN-24" "dd-MMM-yy"))
           {:date-str "06-JUN-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 5 :month-day 5 :seconds 0 :week-day 4 :year 2024 :year-day 157}))
(assert (= (date/assert-date (date/from-string "07-JUL-24" "dd-MMM-yy"))
           {:date-str "07-JUL-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 6 :month-day 6 :seconds 0 :week-day 0 :year 2024 :year-day 188}))
(assert (= (date/assert-date (date/from-string "08-AUG-24" "dd-MMM-yy"))
           {:date-str "08-AUG-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 7 :month-day 7 :seconds 0 :week-day 4 :year 2024 :year-day 220}))
(assert (= (date/assert-date (date/from-string "09-SEP-24" "dd-MMM-yy"))
           {:date-str "09-SEP-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 8 :month-day 8 :seconds 0 :week-day 1 :year 2024 :year-day 252}))
(assert (= (date/assert-date (date/from-string "10-OCT-24" "dd-MMM-yy"))
           {:date-str "10-OCT-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 9 :month-day 9 :seconds 0 :week-day 4 :year 2024 :year-day 283}))
(assert (= (date/assert-date (date/from-string "11-NOV-24" "dd-MMM-yy"))
           {:date-str "11-NOV-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 10 :month-day 10 :seconds 0 :week-day 1 :year 2024 :year-day 315}))
(assert (= (date/assert-date (date/from-string "12-DEC-24" "dd-MMM-yy"))
           {:date-str "12-DEC-24" :format-str "dd-MMM-yy" :dst false :hours 0 :minutes 0 :month 11 :month-day 11 :seconds 0 :week-day 4 :year 2024 :year-day 346}))
